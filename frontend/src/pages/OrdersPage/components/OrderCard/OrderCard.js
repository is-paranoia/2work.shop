    ...
    return (
        ...
        <div className="OrderCard">
            ...
            <div className="card-info">
                    ...
                    <div className="card-price">{order.price} ETH</div>
                    <div className="isStarted">{order.isStarted}</div>
            </div>
            <div className="card-sides">
                <div className="card-authorId">Author: {order.authorId}</div>
                <div className="card-workerId">Worker: {order.workerId}</div>
            </div>
